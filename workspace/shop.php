...
<section class="page-header">
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				<div class="content">
					<h1 class="page-name">Shop Dog Products</h1>
				</div>
			</div>
		</div>
	</div>
                            ...
                            <div class="panel-body">
                                ...
                                <form method="post" action="/shop.php">
                                    ...
                                    <select id="type" name="type" class="form-control">
                                        <option value="NULL">Pet Items</option>
				...
				<div class="row">
                    <?php
                        foreach ($productData as $key => $val) {
                            ...
                            if ($searchTerm == NULL && $typeFilter == NULL && $genderFilter == NULL) {
                            ...
                            if ($typeFilter == "NULL" && $searchFilter == "NULL") {
                                ...
                                if (strpos($val['description'], $searchFilter) !== false) {
                                    require $_SERVER['DOCUMENT_ROOT'].'/searchResults.php';
                                } 
                            } elseif ($typeFilter != NULL && $searchFilter != "NULL") {
                                if (strpos($val['description'], $searchFilter) !== false && $typeFilter == $val['type']) {
                                    require $_SERVER['DOCUMENT_ROOT'].'/searchResults.php';
                                }
                            }
                        }
